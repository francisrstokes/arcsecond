...
- [5. API](#api)
  ...
  - [5.23 endOfInput](#endofinput)
  - [5.24 skip](#skip)
  - [5.25 pipeParsers](#pipeparsers)
  - [5.26 composeParsers](#composeparsers)
  - [5.27 takeRight](#takeright)
  - [5.28 takeLeft](#takeleft)
  - [5.29 recursiveParser](#recursiveparser)
  - [5.30 tapParser](#tapparser)
  - [5.31 decide](#decide)
  - [5.32 mapTo](#mapto)
  - [5.33 leftMapTo](#leftmapto)
  - [5.34 fail](#fail)
  - [5.35 succeedWith](#succeedwith)
  - [5.36 toPromise](#topromise)
  - [5.37 toValue](#tovalue)
